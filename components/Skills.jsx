...
const Skills = () => {
  return (
    ...
    <div id='skills' className='w-full min-h-screen p-2 bg-gray-100 dark:bg-gray-900 text-black dark:text-white'>
      <div className='max-w-[1240px] mx-auto flex flex-col justify-center h-full'>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
          {[
            ...
            <div key={index} className='p-6  rounded-xl hover:scale-105 ease-in duration-300 shadow-md shadow-gray-800 bg-gray-100 dark:bg-gray-800'>
