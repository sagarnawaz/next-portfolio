  ...
  return (
    <div id='about' className='w-full md:h-screen p-2 flex items-center py-16'>
        ...
        <div className='col-span-2'>
            ...
            <h2>Who  I Am</h2>
            <p className='py-2 text-[#e9ecf0]'> I am not normal developer </p>
            <p className='py-2 text-[#e9ecf0]'>
            ...
            <p className='py-2 text-[#e9ecf0] underline cursor-pointer'>Check out some of my latest projects </p>
        </div>
